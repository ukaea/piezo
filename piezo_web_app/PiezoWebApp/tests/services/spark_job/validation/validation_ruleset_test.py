...
def test_get_default_value_for_key_returns_none_when_default_not_defined():
    # Arrange
    validation_dict = {
...
def test_get_keys_for_language_returns_single_conditional():
    # Arrange
    validation_dict = {
        'x': ValidationRule({
...
def test_get_keys_for_language_returns_only_conditional_that_matches():
    # Arrange
    validation_dict = {
        'x': ValidationRule({
            'classification': 'Conditional',
...
def test_get_keys_of_optional_inputs_returns_single_optional_rule():
    # Arrange
    validation_dict = {
...
def test_get_keys_of_optional_inputs_returns_optional_names_from_mixture():
    # Arrange
    validation_dict = {
        'w': ValidationRule({
            'classification': 'Conditional',
...
def test_get_keys_of_required_inputs_returns_empty_list_when_none_optional():
    # Arrange
    validation_dict = {
        'x': ValidationRule({
            'classification': 'Conditional',
...
def test_get_validation_rule_for_key_raises_key_error_when_rule_not_defined():
    # Arrange
    validation_dict = {
        'x': ValidationRule({'classification': 'Required', 'default': '7'}),
        'y': ValidationRule({'classification': 'Optional', 'default': 'banana'})
...
def test_get_validation_rule_for_key_returns_value_when_defined():
    # Arrange
    validation_dict = {
        'x': ValidationRule({'classification': 'Required', 'default': '7'}),
        'y': ValidationRule({'classification': 'Optional'})
