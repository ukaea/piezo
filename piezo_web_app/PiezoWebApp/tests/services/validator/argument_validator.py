...
class TestArgumentValidator:
    ...
    def test_validate_driver_cores_accepts_values_in_both_cpu_and_millicpu_within_valid_range(self, cores):
        # Arrange
        validation_values = self.validation_rules.get_validation_rule_for_key("driver_cores")
        # Act
    ...
    def test_validate_driver_core_limit_accepts_values_in_both_cpu_and_millicpu_within_valid_range(self, core_limit):
        # Arrange
        validation_values = self.validation_rules.get_validation_rule_for_key("driver_core_limit")
        # Act
        validation_result = \
    ...
    def test_validate_driver_memory_accepts_values_for_megabytes_both_string_and_int_formatted(self, memory):
        # Arrange
        validation_values = self.validation_rules.get_validation_rule_for_key("driver_memory")
        # Act
        validation_result = \
    ...
    def test_validate_executors_accepts_numerical_values_within_valid_range(self, executors):
        # Arrange
        validation_values = self.validation_rules.get_validation_rule_for_key("executors")
        # Act
        validation_result = \
    ...
    def test_validate_executor_cores_accepts_numerical_values_within_valid_range(self, executor_cores):
        # Arrange
        validation_values = self.validation_rules.get_validation_rule_for_key("executor_cores")
        # Act
        validation_result = \
    ...
    def test_validate_executor_memory_accepts_numerical_values_within_valid_range(self, executor_memory):
        # Arrange
        validation_values = self.validation_rules.get_validation_rule_for_key("executor_memory")
        # Act
        validation_result = \
