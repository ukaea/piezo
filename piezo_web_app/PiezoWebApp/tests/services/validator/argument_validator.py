...
from PiezoWebApp.src.services.validator.argument_validator import ArgumentValidator
...
class TestArgumentValidator:
    ...
    def setup(self):
        self._mock_validation_rules = mock.create_autospec(ValidationRules)
        self._test_Argument_validator = ArgumentValidator(self._mock_validation_rules)
