...
class TestArgumentValidator:
    ...
    def test_validate_name_validates_non_empty_strings(self, name):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("name")
        # Act
    ...
    def test_validate_language_validates_valid_languages(self, language):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("language")
        # Act
    ...
    def test_validate_python_version_validates_2_and_3(self, version):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("python_version")
        # Act
    ...
    def test_validate_path_to_main_app_file_validates_non_empty_strings(self, path):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("path_to_main_app_file")
        # Act
    ...
    def test_validate_main_class_validates_non_empty_strings(self, main_class):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("main_class")
        # Act
    ...
    def test_validate_driver_cores_accepts_values_in_both_cpu_and_millicpu_within_valid_range(self, cores):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("driver_cores")
        # Act
    ...
    def test_validate_driver_core_limit_accepts_values_in_both_cpu_and_millicpu_within_valid_range(self, core_limit):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("driver_core_limit")
        # Act
    ...
    def test_validate_driver_memory_accepts_values_for_megabytes_both_string_and_int_formatted(self, memory):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("driver_memory")
        # Act
    ...
    def test_validate_executors_accepts_numerical_values_within_valid_range(self, executors):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("executors")
        # Act
    ...
    def test_validate_executor_cores_accepts_numerical_values_within_valid_range(self, executor_cores):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("executor_cores")
        # Act
    ...
    def test_validate_executor_memory_accepts_numerical_values_within_valid_range(self, memory):
        # Arrange
        validation_rule = self.validation_rules.get_validation_rule_for_key("executor_memory")
        # Act
